(function (modules) {
  ...
  // swiper.slideTo(3, 2, false);

  function priceCalc() {

    let totalPrice = 0;
    let plotPrice = Number($('.calculator-change-sector__item_active .calculator-change-sector__item').attr('data-price'));
    let projectPrice = Number($('.project-item-elem_active').attr('data-price'));
    let finishPrice = Number($('input[name="dop"]:checked').val());
    let willingnessPrice = Number($('input[name="home"]:checked').val());
    let adultPrice = Number($('#adults').attr('data-price'));
    let childPrice = Number($('#child').attr('data-price'));

    let adultCount = Number($('#adults').val());
    let childCount = Number($('#child').val());

    adultPrice = adultPrice * adultCount;
    childPrice = childPrice * childCount;

    function calcTotal() {
      totalPrice = plotPrice + projectPrice + finishPrice + willingnessPrice + adultPrice + childPrice;
      $('.totalprice').html(totalPrice);
    }

    calcTotal();

    $('.project-item-elem').click(function () {
      $('.project-item-elem').removeClass('project-item-elem_active');
      $(this).addClass('project-item-elem_active');
      var projectPriceNew = Number($('.project-item-elem_active').attr('data-price'));
      projectPrice = projectPriceNew;
      console.log(projectPrice);
      calcTotal();
    });

    $('input[name="dop"]').click(function () {
      finishPrice = Number($('input[name="dop"]:checked').val());
      calcTotal();
    });

    $('input[name="home"]').click(function () {
      willingnessPrice = Number($('input[name="home"]:checked').val());
      calcTotal();
    });

    $(".switch-btn").on("click", function () {
      var $button = $(this);
      var oldValue = $button.parents('.project-info__human-block-item').find("input").val();
      var priceInput = $button.parents('.project-info__human-block-item').find("input").attr('data-price');

      function updatePriceCount() {
        priceInput = priceInput * newVal;
        if ($button.parents('.project-info__human-block-item').find("input").hasClass('adultinp')) {
          adultPrice = priceInput;
        } else {
          childPrice = priceInput;
        }
        calcTotal();
      }
      ...
      $button.parents('.project-info__human-block-item').find("input").val(newVal);
    });

    $('.calculator-change-sector__item-container').click(function () {
      let newPlotPrice = $(this).find('.calculator-change-sector__item').attr('data-price');
      plotPrice = Number(newPlotPrice);
      calcTotal();
    })
  }
  ...
  $('.real-estate-select__more').click(function (e) {
    e.preventDefault();
    $('.real-estate-select__item').fadeIn();
  })
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Carousel", function () { return m; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Fancybox", function () { return T; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Panzoom", function () { return h; });
...
/***/ (function (module, __webpack_exports__, __webpack_require__) {
      ...
      "use strict";
      __webpack_require__.r(__webpack_exports__);
/* harmony import */ var _modules_carousel__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/carousel */ "./src/js/modules/carousel/index.js");
...
/* harmony import */ var _modules_tabs_tabs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/tabs/tabs */ "./src/js/modules/tabs/tabs.js");
/* harmony import */ var _modules_calendar__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/calendar */ "./src/js/modules/calendar.js");
/* harmony import */ var _modules_plus__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/plus */ "./src/js/modules/plus.js");
/* harmony import */ var _fancyapps_ui__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @fancyapps/ui */ "./node_modules/@fancyapps/ui/dist/fancybox.esm.js");
      ...
      var loader = new _modules_loader__WEBPACK_IMPORTED_MODULE_1__["default"]('#loader-js', '#loader-el-js');
      loader.initLoader();
      ...
      var onLoadHandler = function onLoadHandler() {
        ...
        Object(_modules_tabs_tabs__WEBPACK_IMPORTED_MODULE_3__["initTabs"])('#tabs-real-estate', '.real-estate-select__item', 'real-estate-select__item_active', 'best-real-estate__info-tab_active');
        Object(_modules_tabs_tabs__WEBPACK_IMPORTED_MODULE_3__["initTabs"])('#tech-tabs', '.learn-more-technology__tab', 'learn-more-technology__tab_active', 'learn-more-technology__content_active');
        if ($('#selecting-articles-tabs')) {
          Object(_modules_tabs_tabs__WEBPACK_IMPORTED_MODULE_3__["initTabs"])('#selecting-articles-tabs', '.selecting-articles__tab', 'selecting-articles__tab_active', 'selecting-articles__content_active');
        }
      };
      ...
      var initCalendar = function initCalendar() {
        function Calendar2(id, year, month) {
          var Dlast = new Date(year, month + 1, 0).getDate(),
            ...
            calendar = '<tr class="calendar-block__data-week">',
            month = ['Январь', 'Февраль', 'Март', 'Апрель', 'Май', 'Июнь', 'Июль', 'Август', 'Сентябрь', 'Октябрь', 'Ноябрь', 'Декабрь'];

          if (DNfirst != 0) {
            for (var i = 1; i < DNfirst; i++) {
              calendar += '<td class="calendar-block__data-week_text fz-big">';
            }
          } else {
            for (var i = 0; i < 6; i++) {
              calendar += '<td class="calendar-block__data-week_text fz-big">';
          ...
          for (var i = 1; i <= Dlast; i++) {
            if (i == new Date().getDate() && D.getFullYear() == new Date().getFullYear() && D.getMonth() == new Date().getMonth()) {
              calendar += '<td class="calendar-block__data-week_text fz-big today">' + i;
            } else {
              calendar += '<td class="calendar-block__data-week_text fz-big ">' + i;
            }
        ...
        var isHevCalendar = document.querySelector('#calendar2');
        if (!isHevCalendar) {
          return;
        }
        if (!isHevCalendar) return console.error('calendar not found');
...
/***/ "./src/js/modules/carousel/advantage-carousel.js":
/*!*******************************************************!*\
  !*** ./src/js/modules/carousel/advantage-carousel.js ***!
  \*******************************************************/
/*! exports provided: default */
...
/* harmony import */ var swiper__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! swiper */ "./node_modules/swiper/swiper.esm.js");
      ...
      var advantageCarousel = function advantageCarousel() {
        var swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('#advantage-carousel', {
          // Optional parameters
          slidesPerView: 1,
          autoHeight: true,
          hashNavigation: {
          ...
          pagination: {
            el: '.advantage-description-bottom-item_pagination',
            type: 'fraction',
            formatFractionCurrent: function formatFractionCurrent(number) {
              return "00".concat(number).slice(-2);
            },
            renderFraction: function renderFraction(currentClass) {
              return "<span class=\"".concat(currentClass, "\"></span>");
            }
          },
          // Navigation arrows
          navigation: {
            nextEl: '.advantage-description-bottom-item-btn_right',
            prevEl: '.advantage-description-bottom-item-btn_left',
            disabledClass: 'advantage-description-bottom-item-btn_disabled'
          }
        });
        var navItemsContainer = document.querySelector('.advantage-fon');
        if (!navItemsContainer) {
          return;
        }
        if (!navItemsContainer) return console.error('.advantage-fon - not found');
        navItemsContainer.addEventListener('click', changeActiveNavItem);

        function changeActiveNavItem(e) {
          var elem = e.target;
          var item = elem.closest('.advantage-fon-block-elem');
          if (!item) return;
          var prevActiveMenuItem = navItemsContainer.querySelector('.advantage-fon-block-elem_active');
          prevActiveMenuItem.classList.remove('advantage-fon-block-elem_active');
          item.classList.add('advantage-fon-block-elem_active');
        }

        function checkActiveAttr() {
          var attrActive = $('.swiper-slide-active .advantage-description-number').attr('data-count');
          $('.advantage-fon-block-elem').removeClass('advantage-fon-block-elem_active');
          $('a.advantage-fon-block-elem[href="#' + attrActive + '"]').addClass('advantage-fon-block-elem_active');
        }
...
/* harmony default export */ __webpack_exports__["default"] = (advantageCarousel);

      /***/
    }),

/***/ "./src/js/modules/carousel/blog-carousel.js":
/*!**************************************************!*\
  !*** ./src/js/modules/carousel/blog-carousel.js ***!
  \**************************************************/
/*! exports provided: default */
...
/* harmony import */ var swiper__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! swiper */ "./node_modules/swiper/swiper.esm.js");
      ...
      var blogCarousel = function blogCarousel() {
        return new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('#blog-carousel', {
          // Optional parameters
          slidesPerView: 3,
          spaceBetween: 20,
          // Navigation arrows
          navigation: {
            nextEl: '.articles-list__navigation-btn_next',
            prevEl: '.articles-list__navigation-btn_prev',
            disabledClass: 'articles-list__navigation-btn_inactive'
          },
...
/* harmony default export */ __webpack_exports__["default"] = (blogCarousel);

      /***/
    }),

/***/ "./src/js/modules/carousel/calc-carousel.js":
/*!**************************************************!*\
  !*** ./src/js/modules/carousel/calc-carousel.js ***!
  \**************************************************/
/*! exports provided: default */
...
/* harmony import */ var swiper__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! swiper */ "./node_modules/swiper/swiper.esm.js");
      ...
      var calcCarousel = function calcCarousel() {
        var swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('#cost-calc', {
          // Optional parameters
          slidesPerView: 3,
          spaceBetween: 20,
          // Navigation arrows
        ...
        var container = document.querySelector('#cost-calc');
        if (!container) return console.error('#cost-calc - not found');
...
/* harmony default export */ __webpack_exports__["default"] = (calcCarousel);
...
/* harmony import */ var _calc_carousel__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./calc-carousel */ "./src/js/modules/carousel/calc-carousel.js");
/* harmony import */ var _plot_carousel__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./plot-carousel */ "./src/js/modules/carousel/plot-carousel.js");
/* harmony import */ var _blog_carousel__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./blog-carousel */ "./src/js/modules/carousel/blog-carousel.js");
/* harmony import */ var _advantage_carousel__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./advantage-carousel */ "./src/js/modules/carousel/advantage-carousel.js");
      ...
      var initCarousels = function initCarousels() {
        // Install modules
        swiper_core__WEBPACK_IMPORTED_MODULE_0__["default"].use([swiper_core__WEBPACK_IMPORTED_MODULE_0__["Navigation"], swiper_core__WEBPACK_IMPORTED_MODULE_0__["Pagination"], swiper_core__WEBPACK_IMPORTED_MODULE_0__["HashNavigation"]]); // use Swiper
        if ($('div').is('#cost-calc')) {
          Object(_calc_carousel__WEBPACK_IMPORTED_MODULE_1__["default"])();
        }
        Object(_plot_carousel__WEBPACK_IMPORTED_MODULE_2__["default"])();
        Object(_blog_carousel__WEBPACK_IMPORTED_MODULE_3__["default"])();
        Object(_advantage_carousel__WEBPACK_IMPORTED_MODULE_4__["default"])();
      };
...
/***/ "./src/js/modules/carousel/plot-carousel.js":
/*!**************************************************!*\
  !*** ./src/js/modules/carousel/plot-carousel.js ***!
  \**************************************************/
/*! exports provided: default */
...
/* harmony import */ var swiper__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! swiper */ "./node_modules/swiper/swiper.esm.js");
      ...
      var plotCarousel = function plotCarousel() {

        var plotCarousel = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('#plot-carousel', {
          // Optional parameters
          slidesPerView: 1,
          spaceBetween: 20,
          // Navigation arrows
...
/* harmony default export */ __webpack_exports__["default"] = (plotCarousel);
...
/* harmony import */ var gsap_gsap_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! gsap/gsap-core */ "./node_modules/gsap/gsap-core.js");
      ...
      var Loader = /*#__PURE__*/function () {
        function Loader($loader, $loader_el) {
          _classCallCheck(this, Loader);

          this._container = document.querySelector($loader);
          this._el = document.querySelector($loader_el);
          gsap_gsap_core__WEBPACK_IMPORTED_MODULE_2__["default"].registerPlugin(gsap_CSSPlugin__WEBPACK_IMPORTED_MODULE_1__["default"]);
        }
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initMenu", function () { return initMenu; });
      var initMenu = function initMenu() {
        ...
        var activeCls = 'menu-open';
        var menu = document.querySelector('#menu');
        menuBtn.addEventListener('click', handlerMenuOpen);

        function handlerMenuOpen() {
          menuBtn.classList.toggle(activeCls);
          menu.classList.toggle(activeCls);
...
/***/ "./src/js/modules/plus.js":
/*!********************************!*\
  !*** ./src/js/modules/plus.js ***!
  \********************************/
/*! exports provided: initPlus */
/***/ (function (module, __webpack_exports__, __webpack_require__) {

      "use strict";
      __webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initPlus", function () { return initPlus; });
      var initPlus = function initPlus() {
        var minus = document.querySelector('.minus');
        var plus = document.querySelector('.plus'); //  minus.addEventListener('click'){
        //  }
...
/* harmony import */ var gsap__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! gsap */ "./node_modules/gsap/index.js");
      ...
      var initTabs = function initTabs(tabs, tabsNavigation, activeClsTab, activeClsContent) {
        var tabsContainer = document.querySelector(tabs);
        // if (!tabsContainer) return console.error("".concat(tabs, " - not found"));
        if (!tabsContainer) {
          return;
        }
        var tabsButtons = tabsContainer.querySelectorAll(tabsNavigation);
        // if (!tabsButtons) return console.error("".concat(tabsNavigation, " - not found"));
        var tl = new gsap__WEBPACK_IMPORTED_MODULE_0__["TimelineMax"]();
        tabsContainer.addEventListener('click', handlerClickTab);

        function handlerClickTab(e) {
          var element = e.target;
          var $tab = element.closest(tabsNavigation);
          if (!$tab) return;
          var prevActiveTab = tabsContainer.querySelector(".".concat(activeClsTab));

          // console.log(prevActiveTab);

          var tabId = $tab.id;
          var prevId = prevActiveTab.id;
          var currentTabContent = tabsContainer.querySelector("._".concat(prevId));
          var newTabContent = tabsContainer.querySelector("._".concat(tabId));
          if (!currentTabContent) return console.error("._".concat(prevId, " - not found"));
          if (!newTabContent) return console.error("._".concat(tabId, " - not found"));
          setInactiveBtn(tabsButtons);
          prevActiveTab.classList.remove(activeClsTab);
          $tab.classList.add(activeClsTab);
          tl.to(currentTabContent, {
            opacity: 0,
            duration: 0.5,
            onComplete: function onComplete() {
              currentTabContent.style.display = 'none';
              newTabContent.style.display = 'flex';
              currentTabContent.classList.remove(activeClsContent);
            }
          }).to(newTabContent, {
            opacity: 1,
            duration: 0.3,
            onStart: function onStart() {
              newTabContent.classList.add(activeClsContent);
            }
          });
        }

        function setInactiveBtn(items) {
          items.forEach(function (item) {
            item.style.pointerEvents = 'none';
            setTimeout(function () {
              if (!item.classList.contains(activeClsTab)) item.style.pointerEvents = 'initial';
            }, 1000);
          });
        }
      };
